...
export const INTENT_CATALOG: IntentDefinition[] = [
  ...
  },
  {
    ...
    rawParams: [
      ...
      { name: "scheduledDate", type: "string", description: 'When to work on it: "today", "tomorrow", "Wednesday", or YYYY-MM-DD' },
      { name: "estimatedDurationMinutes", type: "number", description: "Estimated time in minutes if mentioned" },
      { name: "notes", type: "string" },
    ],
  },
  {
    name: "update_task",
    description:
      'User wants to complete, update, or reopen a task (e.g. "I finished call mom", "mark task X done", "set due date on oil change to Friday", "schedule oil change for Wednesday", "estimate 2 hours for the proposal", "reopen the oil change task")',
    rawParams: [
      ...
      { name: "scheduledDate", type: "string", description: 'When to work on it: "today", "tomorrow", "Wednesday", or YYYY-MM-DD' },
      { name: "estimatedDurationMinutes", type: "number", description: "Estimated time to complete in minutes" },
      { name: "durationMinutes", type: "number", description: "Actual duration when completing — creates a task time entry" },
